...
function renderOpeningFamily(family) {
  ...
  return `
    <article class="opening-family-card ${single ? 'single-line-family' : ''}">
      ...
      ${single ? `
        <div class="single-line-actions six-actions">
          <button class="study-button" onclick="openStudyById('${preview.id}')">Study</button>
          <button class="train-opening-button" style="appearance:none;-webkit-appearance:none;background:rgba(56,211,159,.065);border:1px solid rgba(56,211,159,.45);color:#79ffe2" onclick="startTrainingOpening('${preview.id}')">Train</button>
          <button class="opening-puzzle-button" style="appearance:none;-webkit-appearance:none;background:rgba(255,211,77,.065);border:1px solid rgba(255,211,77,.45);color:#ffd34d" onclick="startOpeningPuzzles('${preview.id}')">Puzzle</button>
          <button class="response-repertoire-button" style="appearance:none;-webkit-appearance:none;background:rgba(121,255,226,.065);border:1px solid rgba(121,255,226,.28);color:#79ffe2" onclick="openResponseRepertoire('${preview.id}')">${responseButtonLabel(preview)}</button>
              ...
              <div class="family-line-row">
                ...
                <div class="line-content">
                  ...
                  <div class="line-action-row four-line-actions">
                    ...
                    <button class="line-train-button" style="appearance:none;-webkit-appearance:none;background:rgba(56,211,159,.065);border:1px solid rgba(56,211,159,.45);color:#79ffe2" onclick="startTrainingOpening('${line.id}')">Train</button>
                    <button class="line-puzzle-button" style="appearance:none;-webkit-appearance:none;background:rgba(255,211,77,.065);border:1px solid rgba(255,211,77,.45);color:#ffd34d" onclick="startOpeningPuzzles('${line.id}')">Puzzle</button>
                    <button class="line-response-button" style="appearance:none;-webkit-appearance:none;background:rgba(121,255,226,.065);border:1px solid rgba(121,255,226,.28);color:#79ffe2" onclick="openResponseRepertoire('${line.id}')">Responses</button>

...
function openRatedMatchModal() {
  ...
  $('bot-arena-label').textContent = 'RATED ONLINE';
  ...
  $('bot-opponent-label').textContent = 'OPPONENT';
  ...
  $('bot-strength-label').textContent = s.opponent_username || 'Opponent';
  $('bot-sidebar-title').textContent = 'OPPONENT';
  $('bot-status-title').textContent = 'GAME STATUS';

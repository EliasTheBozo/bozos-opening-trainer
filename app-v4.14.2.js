    ...
    <article class="opening-family-card ${single ? 'single-line-family' : ''}">
      ...
      <div class="opening-action-dock ${single ? 'single' : 'family'}">
        <div class="opening-primary-actions">
          ...
          <button class="opening-master-direct" onclick="openMasterGamesForOpening('${preview.id}','${escapeHtml(single ? challengeName : family.name).replace(/'/g, "\\'")}')">Master games</button>
          ${single ? '' : `

    ...
    <article class="opening-family-card ${single ? 'single-line-family' : ''}">
      ...
      <div class="opening-action-dock ${single ? 'single' : 'family'}">
        <div class="opening-primary-actions">
          ...
          <button class="opening-master-direct" onclick="openMasterGamesForOpening('${masterAnchor.id}','${escapeHtml(single ? challengeName : family.name).replace(/'/g, "\\'")}')"><span class="master-games-button-icon" aria-hidden="true">♜</span><span>Master games</span></button>
          ${single ? '' : `

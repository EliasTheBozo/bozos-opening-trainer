...
function renderProfile() {
  ...
  if (titleRow) {
    ...
    titleRow.innerHTML = titles.map(t => `<span class="profile-title-chip">${escapeHtml(t)}</span>`).join('') + (p.identity_verified ? '<span class="profile-verified-chip" title="Identity verified by BOZO">✓ Verified</span>' : '');
  }

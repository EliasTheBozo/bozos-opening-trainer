...
async function loadBozoPlusCheckout() {
  ...
  try {
    ...
    if($('bozo-paypal-mode-pill')){ $('bozo-paypal-mode-pill').textContent=data.environment === 'sandbox' ? 'Sandbox · Fake money' : 'LIVE · REAL MONEY'; $('bozo-paypal-mode-pill').classList.toggle('live',data.environment==='live'); }
